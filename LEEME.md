...
### 🖼️ Cómo funcionan los PNG Animados
...
## ⚙️ Detalles Técnicos (Compatibilidad Wayland)
...
5. Mueve ambos archivos a `~/.config/conky/` y ejecuta: 
   ```bash
